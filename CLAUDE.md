# Claude Instructions — Blender 3D Print Vibe Coding

## Project Context

This is a 3D design vibe-coding workspace. Claude controls Blender via the **blender-mcp** MCP server to generate, iterate, and export models optimized for 3D printing.
